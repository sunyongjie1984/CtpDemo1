...
void CTraderSpi::OnRspQryTradingAccount(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    ...
    if (bIsLast && !IsErrorRspInfo(pRspInfo))
    {
        ...
        DEBUG(CTPDEMO1_DEBUG, "经纪公司代码: %s 投资者帐号: %s 上次质押金额: %lf 上次信用额度: %lf 上次存款额: %lf 上次结算准备金 %lf 上次占用的保证金 %lf 利息基数 %lf 利息收入 %lf 入金金额 %lf 出金金额 %lf 冻结的保证金 %lf 冻结的资金 %lf 冻结的手续费 %lf  当前保证金总额 %lf 资金差额 %lf 手续费 %lf 平仓盈亏 %lf 持仓盈亏 %lf 期货结算准备金 %lf 可用资金 %lf 可取资金 %lf 基本准备金 %lf 交易日 %s 结算编号 %d 信用额度 %lf 质押金额 %lf 交易所保证金 %lf 投资者交割保证金 %lf 交易所交割保证金 %lf 保底期货结算准备金 %lf 币种代码 %s 上次货币质入金额 %lf 上次货币质出金额 %lf 货币质入金额 %lf 货币质出金额 %lf 货币质押余额 %lf 可质押货币金额 %lf 特殊产品占用保证金 %lf 特殊产品冻结保证金 %lf 特殊产品手续费 %lf 特殊产品冻结手续费 %lf 特殊产品持仓盈亏 %lf 特殊产品平仓盈亏 %lf 根据持仓盈亏算法计算的特殊产品持仓盈亏 %lf 特殊产品交易所保证金 %lf",
