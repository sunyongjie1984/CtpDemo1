...
enum BusinessSequenceEventId
{
    ...
    TS_NOTICE_STARTMARKET_MATCH      = 800004,   /**<TS开始撮合                                  */
    ...
    TS_WARNING_LOADSTOCKTYPEPARTLYFAILED        = 802039,   /**<加载初始化数据（证券类别）部分成功                                   */
    TS_WARNING_LOADSTOCKCODEPARTLYFAILED        = 802040,   /**<加载初始化数据（证券代码）部分成功                                   */
    TS_WARNING_LOADSTOCKACCPARTLYFAILED         = 802041,   /**<加载初始化数据（证券帐户）部分成功                                   */
    TS_WARNING_LOADUNITNOPARTLYFAILED           = 802042,   /**<加载初始化数据（交易单元）部分成功                                   */
    TS_WARNING_LOADBUSITYPEPARTLYFAILED         = 802043,   /**<加载初始化数据（证券允许业务类别）部分成功                           */
    TS_WARNING_LOADTNFLAGEPARTLYFAILED          = 802044,   /**<加载初始化数据（证券交易T+n标识）部分成功                            */
    TS_WARNING_LOADSTOCKPARTLYFAILED            = 802045,   /**<加载初始化数据（证券持仓信息）部分成功                               */
    TS_WARNING_LOADUNITNORESTRICTPARTLYFAILED   = 802046,   /**<加载初始化数据（交易单元限制表）部分成功                             */
    TS_WARNING_LOADACCPROPRESTRICTARTLYFAILED   = 802047,   /**<加载初始化数据（账户性质限制）部分成功                               */
    TS_WARNING_LOADACCRESTRICTPARTLYFAILED      = 802048,   /**<加载初始化数据（证券账户限制）部分成功                               */
    TS_WARNING_LOADMAKERRESTRICTPARTLYFAILED    = 802049,   /**<加载初始化数据（做市限制）部分成功                                   */
    TS_WARNING_LOADFORBIDTIMEPARTLYFAILED       = 802050,   /**<加载初始化数据（申报禁止业务时间）部分成功                           */
    TS_WARNING_LOADMATCHTIMEPARTLYFAILED        = 802051,   /**<加载初始化数据（撮合交易阶段时间设置）部分成功                       */
    TS_WARNING_LOADDEFAULTSYSDATAPARTLYFAILED   = 802052,   /**<加载初始化数据（证券账户性质，交易单元类型默认禁止列表配置）部分成功 */
    ...
    CCOMM_NOTICE_JYZHXX_OK                 = 800656,   //交易综合信息已发送
    CCOMM_NOTICE_STATIC_PUT                = 800657,   //已开始接收中登数据
...
enum UrcommEventId
{
    ...
    URCOMM_WAR_NO_LINK               = 802821, /// 没有有效排队机连接
    URCOMM_WAR_VALID_LINK            = 802822, /// 有有效的排队机连接
    ...
    URCOMM_ERR_LINK_TIME            = 940064, /// link_time配置错误
};
...
enum CcommEventId
{
    ...
    CCOMM_ERROR_NO_CONNECTION            = 950409,  //已开市但中登未连接
    CCOMM_ERROR_DISCONNECTED             = 950410,  //开市期间成交数据连接断开
};
...
enum ACDFrontEventId
{
    ...
    FRONT_NOTICE_SEQ_NO                     = 802904,       // 接收/发送的交换委托单笔数SEQNO重要信息
...
enum QfepEventId
{
	...
	QFEP_NOTICE_MKTAMOPEN = 802509,////**< 开撮:0930 */
	///***crit(970000~970100)***/
	///公共
	...
	///公共(401~450)
	///组播(451~470)
	QFEP_WARNING_DATA = 970451,///收到的组播数据越界
	///write dbf(471~490)
	///tcp(491~510)
	...
	///公告(651~660)
	QFEP_NOTICE_TCP_SEND_SUCCESS = 970651,///公告发送成功
	///***info(970701~970900)***/
	///公共(701~730)
	///数据处理(731~740)
...
enum RepcommEventId
{
    ...
    REPC_WAR_NO_LINK                    = 802622, /**< 没有深证通有效连接建立*/
    REPC_WAR_VALIAD_LINK                = 802623, /**< 有深证通有效连接建立*/
    REPC_NOTICE_SECUKIND                = 802624, /**< 已加载证券类别  */
    REPC_NOTICE_MANUAL_CLOSING          = 802625, /**< 接收手工收市指令  */
    REPC_NOTICE_MAKER_CLOSE             = 802626, /**< 接收盘后收市指令，即9  */
    ...
    REPC_ERR_SSC_TIME_OUT             = 975014, /**< 深圳通接收超时30s没收到数据 */
    REPC_ERR_ACCEPTOR_CREATE          = 975015, /**< 创建tcp侦听失败 */
    REPC_ERR_ACCEPTOR_DESTROY         = 975016, /**< 销毁tcp侦听失败 */
    REPC_ERR_ACCEPTOR_ONERROR         = 975017, /**< tcp通信库错误 */
    ...
    REPC_WAR_NOT_RECV_RM_DATA         = 975030, /**< 没有组播过来的时间片信息 */
    REPC_ERR_SZT_INVALID_SEQNO        = 975031, /**< 非法的seqno,seqno大于dealnum  */
    REPC_INF_DEAL_NO                  = 975032, /**< 发送成交单编号  */
    REPC_INFO_PKT                     = 975033, /**< 无法解析的消息  */
};
...
enum QsEventId
{
    ...
    QS_NOTICE_MATCH_START              =    800127, /**< 撮合开始 **/
    QS_NOTICE_MATCH_END                =    800128, /**< 撮合开始成功 **/
    QS_NOTICE_MATCH_FAIL               =    800129, /**< 撮合开始失败 **/
        
    QS_ORDER_MARKET_ISSUE              =    800130, /**< 做市转让行情发布指令开始 9:15 */
    QS_ORDER_MARKET_ISSUE_OK           =    800131, /**< 做市转让行情发布指令开始 9:15 */
    QS_ORDER_MARKET_MATCH              =    800132, /**< 做市转让撮合指令开始 9:30 */
    QS_ORDER_MARKET_MATCH_OK           =    800133, /**< 做市转让撮合指令开始 9:30 */
    QS_NOTICE_MM_CLOSE                 =    800134, /**< 做市转让收市指令开始 15:00 */
    QS_NOTICE_MM_CLOSE_OK              =    800135, /**< 做市转让收市指令开始 15:00 */

    QS_ORDER_TOWNET_NOTISSUE           =    800136, /**< 两网虚拟成交不发布指令开始 9:30 */
    QS_ORDER_TOWNET_NOTISSUE_OK        =    800137, /**< 两网虚拟成交不发布指令开始 9:30 */
    QS_NOTICE_O3B_CLOSE                =    800138, /**< 两网及退市收市指令开始 15:00*/
    QS_NOTICE_O3B_CLOSE_OK             =    800139, /**< 两网及退市收市指令开始 15:00*/

	QS_ORDER_BID_ISSUE    			   =	800140,	/**< 竞价转让集合竞价指令开始 9:15 */
	QS_ORDER_BID_ISSUE_OK			   =	800141,	/**< 竞价转让集合竞价指令开始 9:15 */
	QS_ORDER_BID_MATCH				   =	800142,	/**< 竞价转让连续竞价指令开始 9:30 */
	QS_ORDER_BID_MATCH_OK			   =	800143,	/**< 竞价转让连续竞价指令开始 9:30 */
	QS_NOTICE_BID_CLOSE				   =	800144,	/**< 竞价转让收市指令开始 15:00 */
	QS_NOTICE_BID_CLOSE_OK			   =	800145,	/**< 竞价转让收市指令开始 15:00 */
...
enum TsEventId
{
    ...
    TS_DEBUG_VALIDRANGE                             = 998101,   /**<撮合主机撮合成交有效价格区间                                                 */
	...
	TS_WARNING_NOLASTMATCHORDER						  = 999501,	 /**对代码进行复盘时，没有找到上一个撮合指令阶段*/
    ...
    TS_DEBUG_STOCK_NOTENOUGH						  = 999830,  /**余额不足，即将主动撤单返回*/
    TS_DEBUG_STOCK_NOTMULTIPLE					      = 999831,  /**买卖数量不是整数倍，即将主动撤单返回*/
    TS_DEBUG_STOCK_LESSMINAMOUNT					  = 999832,  /**小于最小下单数量, 即将主动撤单返回*/
    TS_DEBUG_NOENTRUST							      = 999833,  /**可能原始单不存在或者已全部成交*/
    TS_DEBUG_INVALID_SORT							  = 999834,  /**此交易阶段为非法，现进行撤单返回*/
    TS_DEBUG_NOT_WITHDRAWALS						  = 999835,  /**不能进行撤单处理，即将主动撤单废单返回*/
    TS_DEBUG_REPEATENTRUST						      = 999836,  /**之前已经报过此合同号委托单, 现不处理*/
    TS_DEBUG_ENTRUSTNOTDEAL						      = 999837,  /**此代码已经闭市，对任何委托都概不处理*/
    TS_DEBUG_MARKET_BOTHEXIST						  = 999838,  /**收到一笔新的单向报价单, 发现已存在一笔双向报价单, 将此单向报价单主动撤单返回*/
    TS_DEBUG_MARKET_SINGLEEXIST					      = 999839,  /**收到一笔新的单向报价单, 发现已存在一笔反向单向报价单, 将此单向报价单主动撤单返回*/
    TS_DEBUG_MARKET_ONLYSINGLE					      = 999840,  /**收到一笔新的单向报价单, 发现已存在一笔单向报价单, 将之前的未成交单先撤除掉*/
    TS_DEBUG_TREATY_RICEERROR						  = 999841,  /**不在有效价格区间, 即将主动撤单返回*/
    TS_DEBUG_TREATY_CONFIRM_WITHDRAWALS			      = 999842,  /**确认单找到对手方, 但条件未匹配, 即将对两笔主动撤单返回*/
    TS_DEBUG_TREATY_FIXEDCONFIRM_WITHDRAWALS		  = 999843,  /**定价确认单找到对手方, 但条件未匹配, 即将定价确认单撤单返回*/
    TS_DEBUG_UNABLEENTRUSTINCLOSE					  = 999844,  /**在闭市之间不能下委托单*/
    TS_DEBUG_GREATERTHAN_HIGHPRICE				      = 999845,  /**委托价格大于当日最高价*/
    TS_DEBUG_LESSTHAN_LOWPRICE					      = 999846,  /**委托价格小于当日最低价*/
    TS_DEBUG_GREATERTHAN_PREPRICE                     = 999847,  /**委托价格大于昨收价比*/
    TS_DEBUG_LESSTHAN_PREPRICE					      = 999848,  /**委托价格小于昨收价比*/
    TS_DEBUG_NOPREPRICE					              = 999849,  /**没有前收盘价*/
